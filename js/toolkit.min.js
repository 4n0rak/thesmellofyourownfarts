...
+function(t) {
    ...
    function e(e) {
        return this.each(function() {
            var o = t(this)
              ...
              , n = t.extend({}, i.DEFAULTS, o.data(), "object" == typeof e && e);
            s || o.data("bs.image-grid", s = new i(this,n)),
    ...
    var i = function(e, o) {
        ...
        this.elements = [],
        this.element = e,
        this.albumWidth = t(e).width(),
        this.images = t(e).children(),
        this.options = t.extend({}, i.DEFAULTS, o),
        t(window).on("resize", t.proxy(this.handleResize, this)),
        this.processImages()
    };
    i.VERSION = "3.3.1",
    ...
    i.prototype.handleResize = function() {
        ...
        this.rownum = 1,
        this.elements = [],
        this.albumWidth = t(this.element).width(),
        this.images = t(this.element).children(),
        this.processImages()
    }
    ,
    i.prototype.processImages = function() {
        ...
        this.images.each(function(i) {
            ...
            e.elements.push([this, r, l]),
            e.row += r + e.options.padding,
            e.row > e.albumWidth && e.elements.length && (e.resizeRow(e.row - e.options.padding),
            e.row = 0,
            e.elements = [],
            e.rownum += 1),
            e.images.length - 1 == i && e.elements.length && (e.resizeRow(e.row),
            e.row = 0,
            e.elements = [],
            e.rownum += 1)
        })
    ...
    i.prototype.resizeRow = function(e) {
        ...
        0); a < this.elements.length; a++) {
            ...
            n += l,
            !d && n < this.albumWidth && (l += this.albumWidth - n),
            l--;
            var c = r.is("img") ? r : r.find("img");
            c.width(l),
            c.height(h),
            this.applyModifications(r, d)
        }
    }
    ,
    ...
    t.fn.imageGrid = e,
    t.fn.imageGrid.Constructor = i,
    t.fn.imageGrid.noConflict = function() {
        return t.fn.imageGrid = o,
        this
    }
    ,
    t(function() {
...
+function(t) {
    ...
    e.prototype._zoom = function(e) {
        ...
        if (o && "IMG" == o.tagName && !this._$body.hasClass("zoom-overlay-open"))
            return e.metaKey || e.ctrlKey ? window.open(e.target.getAttribute("data-original") || e.target.src, "_blank") : void (o.width >= t(window).width() - i.OFFSET || (this._activeZoomClose(!0),
            this._activeZoom = new i(o),
    ...
    i.prototype._calculateZoom = function() {
        ...
        e / this._targetImage.width)
          , n = t(window).height() - i.OFFSET
          , a = t(window).width() - i.OFFSET
          , r = e / o
          , l = a / n;
        e < a && o < n ? this._imgScaleFactor = s : r < l ? this._imgScaleFactor = n / o * s : this._imgScaleFactor = a / e * s
    }
    ,
